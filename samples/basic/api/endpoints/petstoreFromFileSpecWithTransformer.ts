...
export const getListPetsMockHandler = (overrideResponse?: PetsArray | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PetsArray> | PetsArray)) => {
  return http.get('*/v:version/pets', async (info) => {await delay(1000);
...
export const getCreatePetsMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<void> | void)) => {
...
export const getListPetsNestedArrayMockHandler = (overrideResponse?: PetsNestedArray | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PetsNestedArray> | PetsNestedArray)) => {
  return http.get('*/v:version/pets-nested-array', async (info) => {await delay(1000);
...
export const getShowPetByIdMockHandler = (overrideResponse?: Pet | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<Pet> | Pet)) => {
  return http.get('*/v:version/pets/:petId', async (info) => {await delay(1000);
