...
export const listPetsResponseItem = zod.preprocess(stripNill, zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict().or(zod.object({
  "length": zod.number(),
...
export const createPetsResponse = zod.preprocess(stripNill, zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict().or(zod.object({
  "length": zod.number(),
...
export const updatePetsResponse = zod.preprocess(stripNill, zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict().or(zod.object({
  "length": zod.number(),
...
export const showPetByIdResponse = zod.preprocess(stripNill, zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict().or(zod.object({
  "length": zod.number(),
